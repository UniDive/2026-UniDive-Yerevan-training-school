...
<font color="red">📌 Pick three genres and type their names inside the quotes where you see X, Y, and Z.</font>
...
# <STUDENT-TODO>
get_diversity_for_genres(("conversation", "podcast", "vlog")) # just one to ensure the cell works, but this needs to be modified
# </STUDENT-TODO>
