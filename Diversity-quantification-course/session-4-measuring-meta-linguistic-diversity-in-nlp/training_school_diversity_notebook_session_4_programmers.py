...
Complete the function `get_diversity_from_languages` below to calculate the disparity of a subset of languages. It should use
`get_submatrix_and_relevant_indices_for_languages` defined above. See the comments for more instructions.
"""
...
Use the function above to find the subset of 5 languages with the highest disparity.
"""
...
In Section 4, we used distance averaging as an aggregation. Can you propose a different method of aggregation?
