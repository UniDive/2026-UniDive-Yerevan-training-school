# -*- coding: utf-8 -*-
"""training_school_diversity_notebook_session_4_non_programmers.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1YSKeLZMEmQqec7ZLiF9Tr6xbwPae2pQy
...
Use the function above several times to find the subset of 5 languages with as high disparity as possible. If you wish to refresh the display, rerun the cell with "display" above.
"""

my_languages = ("pol","ukr","slv","lit","ces")

# <STUDENT-TODO>
my_languages = ("pol","ukr","fra","lit","ces")
